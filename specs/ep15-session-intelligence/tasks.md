...
- [x] T006 Update `src/persistence/schemas.ts` to export EP15 schema version constant
...
- [x] T011 [P] Add schema version migration logic (version 2 → 3)
- [x] T012 Write unit test for schema initialization in `tests/unit/sessions/storage/schema.test.ts`
- [x] T013 Create `src/sessions/storage/queries.ts` with SQL query helper functions
