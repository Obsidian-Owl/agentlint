...
- [ ] T002 [P] Create `src/security/` directory structure per plan.md
- [ ] T003 [P] Create `src/eval/` directory structure per plan.md
- [ ] T004 [P] Create `tests/evals/golden/` directory structure per plan.md
...
- [ ] T007 [P] Create type exports in `src/debug/types.ts` per contracts/debug.ts
...
- [ ] T011 Create namespace constants in `src/debug/namespaces.ts` per DEBUG_NAMESPACES
...
- [ ] T019 [US1] Implement DebugLogger class in `src/debug/logger.ts` (depends on T011, T013)
- [ ] T020 [US1] Implement namespaced child logger in `src/debug/logger.ts`
- [ ] T021 [US1] Implement file output in `src/debug/logger.ts` (depends on T019)
- [ ] T022 [US1] Add CLI flags (--verbose, --debug, --quiet, --log-file) to `src/cli/program.ts` (depends on T019)
- [ ] T023 [US1] Integrate DebugLogger with existing orchestration in `src/orchestration/orchestrator.ts`
...
- [ ] T035 [P] [US2] Create E2E test structure in `tests/e2e/`
- [ ] T036 [P] [US2] Create test fixtures with known issues in `tests/e2e/fixtures/`
...
- [ ] T043 [P] [US3] Unit test for code-based grader in `tests/unit/eval/code-based.test.ts`
