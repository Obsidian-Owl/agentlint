...
|-----------|------------|-------|
| I. Local-First | ✅/⚠️/❌ | No network calls without user opt-in; user-provided LLM credentials only |
| II. Improvement-Oriented | ✅/⚠️/❌ | Supports continuous improvement cycle; enables historical comparison |
| III. Causal-First | ✅/⚠️/❌ | Issues traced to origin; recommendations are preventive not just symptomatic |
...
**MVP Scope Check**: [Confirm feature does not violate MVP non-goals]
