/**
 * EP14: Skills Effectiveness Analysis - Type Definitions
 *
 * TypeScript interfaces for skills analysis tools.
 * Per Constitution Principle VII: Tools return data, not judgments.
 *
 * @module src/skills/types
 */
 ...
 */
export interface SkillsToolResult<T> {
  success: boolean;
  data?: T;
  error?: SkillsError;
}
