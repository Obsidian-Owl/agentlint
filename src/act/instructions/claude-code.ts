 ...
 *
 * Context-engineered system prompt for analyzing Anthropic's Claude Code
 * AI coding assistant configurations and session history.
 *
 ...
 */
const CLAUDE_CODE_PROMPT = `## ROLE IDENTITY
...
/**
 * T020: Claude Code Analyzer subagent instructions.
 *
 * Specialized for analyzing Anthropic's Claude Code configurations
 * and session history.
 */
...
// Prompt size: ~7,200 bytes (well under 50KB limit)
