...
export const generalizedAnalyzerPromptV1: StaticPromptSpec = {
  id: 'subagent/generalized-analyzer',
  version: '1.0.0',
  createdAt: '2026-01-27T00:00:00Z',
  description: 'Fallback analyzer for unknown or generic ACT configurations',
  tags: ['subagent', 'act', 'fallback'],
  messages: [
    {
      role: 'system',
