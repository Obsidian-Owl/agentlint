...
export const claudeCodeAnalyzerPromptV1: StaticPromptSpec = {
  id: 'subagent/claude-code-analyzer',
  version: '1.0.0',
  createdAt: '2026-01-27T00:00:00Z',
  description: 'Claude Code specialist subagent for analyzing CLAUDE.md, settings, and sessions',
  tags: ['subagent', 'act', 'claude-code'],
  messages: [
    {
      role: 'system',
